...
import com.viizfo.p3_navigation_splash.databinding.FragmentBookingBinding
...
class booking : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnBooking.setOnClickListener{
            Toast.makeText(activity, "You booked at " + spinner.selectedItem.toString(), Toast.LENGTH_LONG).show()
