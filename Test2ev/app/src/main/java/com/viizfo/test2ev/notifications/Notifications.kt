package com.viizfo.test2ev.notifications
...
import com.viizfo.test2ev.MainActivity
import com.viizfo.test2ev.R
...
class Notifications(private val context: Context, private val title:String, private val shortText:String?, private val longText:String? ) {
    ...
    private val CHANNEL_NAME = "NotificationsTest2ev"
    private val CHANNEL_ID: String = "Notification_ID_test2ev"
    init{
        makePendingIntent()
